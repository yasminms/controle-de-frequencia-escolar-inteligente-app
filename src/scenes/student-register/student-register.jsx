...
import { Label, Input, Column, Radio, MaskInput } from '@/components'
...
export const StudentRegister = () => {
  ...
  return (
    <div className='student-register'>
      <Column>
        <Label text='Nome' htmlFor='name' className='student-register__label' />
        <div className='student-register__normal-input'>
          <Input
      ...
      <div className='student-register__fifth-container'>
        <div className='student-register__special-row'>
          <Column>
            <Label text='Sexo' htmlFor='sexo' />
            <div className='student-register__special-row__radio'>
              <Radio
                labelText='Feminino'
                name='gender'
        ...
        <div className='student-register__special-row right-container'>
          <Column>
